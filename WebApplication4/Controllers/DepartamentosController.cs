...
namespace WebApplication4.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo,Departamento,Nombre")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo,Departamento,Nombre")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
